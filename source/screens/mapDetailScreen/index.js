            ...
            <View style={styles.containerView}>
                ...
                <View style={styles.header}>
                    <View style={{ flex: 2 }}>
                        ...
                        >
                            <Image source={constants.images.backArrowWhite} style={{ height: 18, width: 18, margin: 10 }} />
                        </TouchableOpacity>
                    </View>
                    <View style={{ flex: 3 }}>
                        <Text style={[styles.headingText]}>Find a verified {'\n'}
                    therapist now</Text>
                    </View>
                ...
                <View style={styles.LocationInput}>
                    <View style={styles.locationInputBox}>
                        <Image source={constants.images.ic_location} style={{ height: 27, width: 18, margin: 12 }} />
                        <TextInput
                ...
                <View style={styles.mapScreen}>
                    ...
                    <View style={styles.therapistInfo}>
                        <View style={{ justifyContent: "space-around", alignItems: 'center' }}>
                            <Image source={constants.images.defaultUserImage} style={{ width: 90, height: 90, flex: 1, borderRadius: 10 }} />
