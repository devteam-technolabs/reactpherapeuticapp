...
const MyProfile = (props) => {
  ...
  return (
    <View style={styles.container} >
      <Image resizeMode={'stretch'} source={constants.images.background} style={styles.containerBackground} />
        ...
        <View style={styles.pofileView} >
          <View style={styles.profileWrap} >
            <View style={styles.profileImageWrap} >
              <Image style={styles.profileImageWrap} source={constants.images.defaultUserImage} />
            </View>
        ...
        <View style={styles.optionsWrap} >
          ...
          <View style={styles.optionItem} >
            <View style={styles.optionNameView} >
              <Image source={constants.images.history} resizeMode={'contain'} style={styles.optionImage} />
          ...
          <View style={styles.optionItem} >
            <View style={styles.optionNameView} >
              <Image source={constants.images.aboutUs} resizeMode={'contain'} style={styles.optionImage} />
          ...
          <View style={styles.optionItem} >
            <View style={styles.optionNameView} >
              <Image source={constants.images.contactUs} resizeMode={'contain'} style={styles.optionImage} />
          ...
          <View style={styles.optionItem} >
            <View style={styles.optionNameView} >
              <Image source={constants.images.privacyPolicy} resizeMode={'contain'} style={styles.optionImage} />
          ...
          <View style={styles.optionItem} >
            <View style={styles.optionNameView} >
              <Image source={constants.images.termsAndConditions} resizeMode={'contain'} style={styles.optionImage} />
          ...
          >
            <View style={styles.optionNameView} >
              <Image source={constants.images.logout} resizeMode={'contain'} style={styles.optionImage} />
      ...
      <LogoutAlert showModal={showModal} setShowModal={setShowModal} navigation={navigation} />
    </View>
  )
};
