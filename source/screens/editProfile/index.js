...
const EditProfile = (props) => {
  ...
  useEffect(() => {
    ...
    setLanguage(userData.languages.length ? userData['languages'][0]['title'] : 'English');
    setLanguage_id(userData.languages.length ? userData['languages'][0]['id'] : '1');
  ...
  >
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.container} >
      ...
      <View style={styles.formView} >
        <View style={styles.formWrap} >
          <TouchableOpacity
            onPress={() => uploadImage()}
            style={{ justifyContent: 'center', alignItems: 'center', backgroundColor: '#ffffff', margin: 10, borderRadius: 10 }} >
            {
              image
                ?
                <Image source={{ uri: localURL || image }} style={styles.profileImage} />
                :
                <Image source={localURL ? { uri: localURL } : constants.images.defaultUserImage} style={styles.profileImage} />
            }
          ...
          <View style={styles.formField} >
            ...
            <View style={styles.fieldInputWrap} >
              ...
              <View style={styles.editWrap} >
                <Image source={constants.images.ic_edit} style={{ width: 13, height: 11.5 }} />
              </View>
            </View>
          </View>
          ...
          <View style={styles.formField} >
            ...
            <View style={styles.fieldInputWrap} >
              <TextInput
                ...
                editable={false}
              />
              <TouchableOpacity onPress={() => setShowLanguages(true)} style={styles.editWrap} >
                <Image source={constants.images.ic_edit} style={{ width: 13, height: 11.5 }} />
              </TouchableOpacity>
            </View>
          </View>
              ...
              <View style={styles.formField} >
                ...
                <View style={styles.fieldInputWrap} >
                  <TextInput
                    ...
                    autoCorrect={false}
                  />
                  <TouchableOpacity onPress={() => setShowSpecialism(true)} style={styles.editWrap} >
                    <Image source={constants.images.ic_edit} style={{ width: 13, height: 11.5 }} />
                  </TouchableOpacity>
                </View>
              </View>
    ...
    <AwesomeAlert
      ...
      confirmText="Confirm"
      confirmButtonColor={constants.colors.lightBlue}
      onCancelPressed={() => {
        setShowAlert(false);
      }}
      onConfirmPressed={() => {
